...
def run_cmd(argv):
    ...
    parser.add_argument("midi", type=mido.MidiFile, help="the MIDI to play with the wav sample")
    parser.add_argument("output", type=argparse.FileType("wb"), help="path for the output wav file")

    parser.add_argument("--config", "--cfg", type=argparse.FileType("r"), help="the config file (see https://meme.institute/swood/config)")
